    ...
    <>
      <div className="alignContent">
        <div className="selectAllContent">
          ...
          <span className="subTitle"> / Branch / Create</span>
          <div className="highLight">
            <div className="row ">
              <div className="col-3 inputFieldAcc">
                <label className="labelSet">Sales</label>
                <sup>
                ...
                <div>
                  ...
                  <label className="labelSet3">Sales Office</label>
                </div>
                <div>
                  <input className="radio" type="radio" />
                  <label className="labelSet3">
                    Sales office & Card Serice Center
                  </label>
                </div>
              </div>
              <div className="col-3 inputFieldAcc">
              ...
              <div className="col-3 inputFieldAcc">
                <label className="labelSet">Address</label>
                <sup>
                  <img className="star" src={star} alt="star" />
                </sup>
                <br />
              ...
              <div className="col-3 inputFieldAcc">
                <label className="labelSet">Phone Number</label>
                <sup>
                  <img className="star" src={star} alt="star" />
                </sup>
                <br />
            ...
            <div className="row ">
              <div className="col-3 inputFieldAcc">
                <label className="labelSet">Username</label>
                <sup>
                  <img className="star" src={star} alt="star" />
                </sup>
                <br />
              ...
              <div className="col-3 inputFieldAcc">
                <label className="labelSet">Password</label>
                <sup>
                  <img className="star" src={star} alt="star" />
                </sup>
                <br />
